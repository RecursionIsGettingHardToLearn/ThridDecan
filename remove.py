...
# Filtra carpetas que no sean carpetas de clases válidas (por ejemplo, evita directorios del sistema)
all_dirs = [d for d in os.listdir(BASE_DIR) if os.path.isdir(os.path.join(BASE_DIR, d)) 
            and d not in ['Boot', 'Windows', 'Program Files', 'ProgramData', '$RECYCLE.BIN', 'System Volume Information', 'Documents and Settings', 'Program Files (x86)', 'PerfLogs', 'Users', 'escaneos']]
